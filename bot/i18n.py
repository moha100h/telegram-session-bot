...
_T: dict[str, dict[str, str]] = {
    ...
    'admin_panel_btn': {'en': "🔧 Admin Panel", 'fa': "🔧 پنل مدیریت", 'ar': "🔧 لوحة الإدارة", 'he': "🔧 פאנל ניהול", 'ru': "🔧 Панель админа"},
    'btn_orders': {'en': "📦 Orders", 'fa': "📦 سفارشات", 'ar': "📦 الطلبات", 'he': "📦 הזמנות", 'ru': "📦 Заказы"},
    'btn_profile': {'en': "👤 Profile", 'fa': "👤 پروفایل", 'ar': "👤 الملف الشخصي", 'he': "👤 פרופיל", 'ru': "👤 Профиль"},
    'btn_support': {'en': "🎧 Support", 'fa': "🎧 پشتیبانی", 'ar': "🎧 الدعم", 'he': "🎧 תמיכה", 'ru': "🎧 Поддержка"},
    'btn_top_up': {'en': "💰 Top Up", 'fa': "💰 افزایش موجودی", 'ar': "💰 شحن الرصيد", 'he': "💰 טעינת יתרה", 'ru': "💰 Пополнить"},
    'btn_wallet': {'en': "💳 Wallet", 'fa': "💳 کیف پول", 'ar': "💳 المحفظة", 'he': "💳 ארנק", 'ru': "💳 Кошелёк"},
    'choose_section': {'en': "Choose a section:", 'fa': "یک بخش را انتخاب کنید:", 'ar': "اختر قسمًا:", 'he': "בחר מדור:", 'ru': "Выберите раздел:"},
    'deposit_await_admin': {'en': "⏳ Awaiting admin confirmation.", 'fa': "⏳ منتظر تایید نهایی ادمین باشید.", 'ar': "⏳ في انتظار تأكيد المشرف.", 'he': "⏳ ממתין לאישור מנהל.", 'ru': "⏳ Ожидайте подтверждения администратора."},
    'deposit_cancelled': {'en': "❌ Deposit cancelled.", 'fa': "❌ واریز لغو شد.", 'ar': "❌ تم إلغاء الإيداع.", 'he': "❌ ההפקדה בוטלה.", 'ru': "❌ Пополнение отменено."},
    'deposit_checking': {'en': "🔍 <b>Checking transaction...</b>", 'fa': "🔍 <b>در حال بررسی تراکنش...</b>", 'ar': "🔍 <b>جارٍ التحقق...</b>", 'he': "🔍 <b>בודק עסקה...</b>", 'ru': "🔍 <b>Проверяем транзакцию...</b>"},
    'deposit_choose_coin': {'en': "💳 <b>Deposit</b>\n\nChoose currency:\n\n<i>💡 Amount in USD — crypto calculated live.</i>", 'fa': "💳 <b>واریز موجودی</b>\n\nارز مورد نظر را انتخاب کنید:\n\n<i>💡 مبلغ به دلار وارد می‌شود — معادل ارز به‌صورت لحظه‌ای محاسبه می‌شود.</i>", 'ar': "💳 <b>إيداع</b>\n\nاختر العملة:", 'he': "💳 <b>הפקדה</b>\n\nבחר מטבע:", 'ru': "💳 <b>Пополнение</b>\n\nВыберите валюту:"},
    'deposit_coin_inactive': {'en': "❌ This currency is no longer active.", 'fa': "❌ این ارز دیگر فعال نیست.", 'ar': "❌ هذه العملة لم تعد نشطة.", 'he': "❌ מטבע זה אינו פעיל.", 'ru': "❌ Эта валюта больше не активна."},
    'deposit_enter_amount': {'en': "💵 Enter amount in <b>USD</b>:\n<i>(e.g. 10 or 25.5)</i>", 'fa': "💵 مبلغ مورد نظر را به <b>دلار</b> وارد کنید:\n<i>(مثال: 10 یا 25.5)</i>", 'ar': "💵 أدخل المبلغ بالدولار:", 'he': "💵 הזן סכום בדולר:", 'ru': "💵 Введите сумму в USD:"},
    'deposit_fake_token': {'en': "🚫 <b>Deposit rejected — fake token!</b>", 'fa': "🚫 <b>واریز رد شد — توکن جعلی!</b>", 'ar': "🚫 <b>تم رفض الإيداع — رمز مزيف!</b>", 'he': "🚫 <b>ההפקדה נדחתה — אסימון מזויף!</b>", 'ru': "🚫 <b>Депозит отклонён — фейковый токен!</b>"},
    'deposit_hash_empty': {'en': "❌ Hash link cannot be empty.", 'fa': "❌ لینک هش تراکنش نمی‌تواند خالی باشد.", 'ar': "❌ رابط الهاش لا يمكن أن يكون فارغًا.", 'he': "❌ קישור האש לא יכול להיות ריק.", 'ru': "❌ Ссылка на хэш не может быть пустой."},
    'deposit_invalid_amount': {'en': "❌ Enter a valid amount (e.g. 10 or 25.5)", 'fa': "❌ مبلغ معتبر وارد کنید (مثال: 10 یا 25.5)", 'ar': "❌ أدخل مبلغًا صحيحًا", 'he': "❌ הזן סכום תקין", 'ru': "❌ Введите корректную сумму"},
    'deposit_no_method': {'en': "⚠️ No payment method active.\n\nContact support.", 'fa': "⚠️ هیچ روش پرداختی فعال نیست.\n\nلطفاً با پشتیبانی تماس بگیرید.", 'ar': "⚠️ لا توجد طريقة دفع نشطة.", 'he': "⚠️ אין שיטת תשלום פעילה.", 'ru': "⚠️ Нет активных методов оплаты."},
    'deposit_price_error': {'en': "⚠️ Price fetch error. Try again.", 'fa': "⚠️ خطا در دریافت قیمت. لطفاً دوباره امتحان کنید.", 'ar': "⚠️ خطأ في جلب السعر.", 'he': "⚠️ שגיאה בקבלת מחיר.", 'ru': "⚠️ Ошибка получения цены."},
    'deposit_send_hash': {'en': "✅ After sending, submit the transaction hash link.", 'fa': "✅ پس از واریز روی دکمه زیر بزنید و لینک هش تراکنش را ارسال کنید.", 'ar': "✅ بعد الإرسال، أرسل رابط الهاش.", 'he': "✅ לאחר השליחה, שלח קישור האש.", 'ru': "✅ После отправки пришлите хэш транзакции."},
    'deposit_submitted': {'en': "<b>Deposit request submitted!</b>", 'fa': "<b>درخواست واریز ثبت شد!</b>", 'ar': "<b>تم تقديم طلب الإيداع!</b>", 'he': "<b>בקשת ההפקדה הוגשה!</b>", 'ru': "<b>Запрос на пополнение отправлен!</b>"},
    'help_full': {'en': "📖 Full Guide", 'fa': "📖 راهنمای کامل", 'ar': "📖 الدليل الكامل", 'he': "📖 מדריך מלא", 'ru': "📖 Полное руководство"},
    'help_notes': {'en': "⚠️ Important Notes", 'fa': "⚠️ نکات مهم", 'ar': "⚠️ ملاحظات مهمة", 'he': "⚠️ הערות חשובות", 'ru': "⚠️ Важные заметки"},
    'help_order': {'en': "🛒 Place Order", 'fa': "🛒 ثبت سفارش", 'ar': "🛒 تقديم طلب", 'he': "🛒 ביצוע הזמנה", 'ru': "🛒 Оформить заказ"},
    'help_refund_note': {'en': "• If rejected, full refund\n• If partial, remaining refunded", 'fa': "• در صورت رد سفارش، مبلغ به‌طور کامل بازگشت داده می‌شود\n• در صورت تکمیل جزئی، مابقی مبلغ بازگشت داده می‌شود", 'ar': "• في حالة الرفض، يتم استرداد المبلغ كاملاً", 'he': "• במקרה דחייה, מוחזר הסכום במלואו", 'ru': "• При отклонении — полный возврат\n• При частичном — возврат остатка"},
    'help_track': {'en': "📦 Track Order", 'fa': "📦 پیگیری سفارش", 'ar': "📦 تتبع الطلب", 'he': "📦 מעקב הזמנה", 'ru': "📦 Отследить заказ"},
    'help_wallet': {'en': "💳 Wallet Top-Up", 'fa': "💳 شارژ کیف پول", 'ar': "💳 شحن المحفظة", 'he': "💳 טעינת ארנק", 'ru': "💳 Пополнение кошелька"},
    'history_empty': {'en': "📜 No order history.", 'fa': "📜 تاریخچه‌ای وجود ندارد.", 'ar': "📜 لا يوجد سجل طلبات.", 'he': "📜 אין היסטוריית הזמנות.", 'ru': "📜 История заказов пуста."},
    'history_page': {'en': "Page {page}", 'fa': "صفحه {page}", 'ar': "الصفحة {page}", 'he': "עמוד {page}", 'ru': "Страница {page}"},
    ...
    'new_order_choose': {'en': "🛒 <b>New Order</b>\n\nChoose a panel:", 'fa': "🛒 <b>سفارش جدید</b>\n\nیک پنل را انتخاب کنید:", 'ar': "🛒 <b>طلب جديد</b>\n\nاختر لوحة:", 'he': "🛒 <b>הזמנה חדשה</b>\n\nבחר פאנל:", 'ru': "🛒 <b>Новый заказ</b>\n\nВыберите панель:"},
    'order_date_lbl': {'en': "Date", 'fa': "تاریخ", 'ar': "التاريخ", 'he': "תאריך", 'ru': "Дата"},
    'order_detail_title': {'en': "📋 <b>Order Detail</b>", 'fa': "📋 <b>جزئیات سفارش</b>", 'ar': "📋 <b>تفاصيل الطلب</b>", 'he': "📋 <b>פרטי הזמנה</b>", 'ru': "📋 <b>Детали заказа</b>"},
    'order_refund': {'en': "↩️ Refund", 'fa': "↩️ بازگشت وجه", 'ar': "↩️ استرداد", 'he': "↩️ החזר", 'ru': "↩️ Возврат"},
    'order_status_lbl': {'en': "Status", 'fa': "وضعیت", 'ar': "الحالة", 'he': "סטטוס", 'ru': "Статус"},
    'orders_active': {'en': "📦 <b>Active Orders</b>\n\nChoose a panel:", 'fa': "📦 <b>سفارش‌های فعال</b>\n\nیک پنل را انتخاب کنید:", 'ar': "📦 <b>الطلبات النشطة</b>\n\nاختر لوحة:", 'he': "📦 <b>הזמנות פעילות</b>\n\nבחר פאנל:", 'ru': "📦 <b>Активные заказы</b>\n\nВыберите панель:"},
    'orders_count': {'en': "{n} orders", 'fa': "{n} سفارش", 'ar': "{n} طلبات", 'he': "{n} הזמנות", 'ru': "{n} заказов"},
    'orders_empty': {'en': "📦 No active orders.", 'fa': "📦 سفارش فعالی وجود ندارد.", 'ar': "📦 لا توجد طلبات نشطة.", 'he': "📦 אין הזמנות פעילות.", 'ru': "📦 Активных заказов нет."},
    'profile_balance': {'en': "💰 Balance", 'fa': "💰 موجودی", 'ar': "💰 الرصيد", 'he': "💰 יתרה", 'ru': "💰 Баланс"},
    'profile_joined': {'en': "📅 Joined", 'fa': "📅 عضویت", 'ar': "📅 تاريخ الانضمام", 'he': "📅 הצטרף", 'ru': "📅 Дата регистрации"},
    'profile_name': {'en': "🔵 Name", 'fa': "🔵 نام", 'ar': "🔵 الاسم", 'he': "🔵 שם", 'ru': "🔵 Имя"},
    'profile_phone_no': {'en': "📱 Phone: ❌ Not verified", 'fa': "📱 شماره: ❌ تایید نشده", 'ar': "📱 الهاتف: ❌ غير موثق", 'he': "📱 טלפון: ❌ לא מאומת", 'ru': "📱 Телефон: ❌ Не подтверждён"},
    'profile_phone_ok': {'en': "📱 Phone: <b>{phone}</b>  ✅", 'fa': "📱 شماره: <b>{phone}</b>  ✅ تایید شده", 'ar': "📱 الهاتف: <b>{phone}</b>  ✅", 'he': "📱 טלפון: <b>{phone}</b>  ✅", 'ru': "📱 Телефон: <b>{phone}</b>  ✅"},
    'profile_phone_prompt': {'en': "📱 Send your phone number:", 'fa': "📱 شماره موبایل خود را ارسال کنید:", 'ar': "📱 أرسل رقم هاتفك:", 'he': "📱 שלח את מספר הטלפון שלך:", 'ru': "📱 Отправьте номер телефона:"},
    'profile_phone_saved': {'en': "✅ Phone verified!", 'fa': "✅ شماره تایید شد!", 'ar': "✅ تم التحقق من الهاتف!", 'he': "✅ הטלפון אומת!", 'ru': "✅ Телефон подтверждён!"},
    'profile_referrals': {'en': "👥 Referrals", 'fa': "👥 دعوت‌ها", 'ar': "👥 الإحالات", 'he': "👥 הפניות", 'ru': "👥 Рефералы"},
    'profile_title': {'en': "👤 <b>My Profile</b>", 'fa': "👤 <b>پروفایل من</b>", 'ar': "👤 <b>ملفي الشخصي</b>", 'he': "👤 <b>הפרופיל שלי</b>", 'ru': "👤 <b>Мой профиль</b>"},
    'profile_username': {'en': "🔹 Username", 'fa': "🔹 یوزرنیم", 'ar': "🔹 اسم المستخدم", 'he': "🔹 שם משתמש", 'ru': "🔹 Юзернейм"},
    'st_cancelled': {'en': "❌ Cancelled", 'fa': "❌ کنسل", 'ar': "❌ ملغى", 'he': "❌ בוטל", 'ru': "❌ Отменено"},
    'st_completed': {'en': "✅ Completed", 'fa': "✅ تکمیل", 'ar': "✅ مكتمل", 'he': "✅ הושלם", 'ru': "✅ Выполنено"},
    'st_partial': {'en': "⚠️ Partial", 'fa': "⚠️ ناقص", 'ar': "⚠️ جزئي", 'he': "⚠️ חלקי", 'ru': "⚠️ Частично"},
    'st_pending': {'en': "⏳ Queued", 'fa': "⏳ در صف", 'ar': "⏳ في الانتظار", 'he': "⏳ בתור", 'ru': "⏳ В очереди"},
    'st_processing': {'en': "🔄 Processing", 'fa': "🔄 در حال انجام", 'ar': "🔄 قيد التنفيذ", 'he': "🔄 בעיבוד", 'ru': "🔄 В обработке"},
    'st_rejected': {'en': "❌ Rejected", 'fa': "❌ رد", 'ar': "❌ مرفوض", 'he': "❌ נדחה", 'ru': "❌ Отклонено"},
    'support_only': {'en': "📞 <b>Support</b>\n\nClick below to contact support 👇", 'fa': "📞 <b>پشتیبانی</b>\n\nبرای ارتباط با تیم پشتیبانی کلیک کنید 👇", 'ar': "📞 <b>الدعم</b>\n\nانقر أدناه للتواصل 👇", 'he': "📞 <b>תמיכה</b>\n\nלחץ למטה לפנייה 👇", 'ru': "📞 <b>Поддержка</b>\n\nНажмите ниже для связи 👇"},
    'support_text': {'en': "Choose a topic or contact support 👇", 'fa': "یک موضوع را انتخاب کنید 👇\nیا مستقیماً با پشتیبانی در ارتباط باشید.", 'ar': "اختر موضوعًا أو تواصل مع الدعم 👇", 'he': "בחר נושא או צור קשר עם התמיכה 👇", 'ru': "Выберите тему или напишите в поддержку 👇"},
    'support_title': {'en': "📞 <b>Support & Help</b>", 'fa': "📞 <b>پشتیبانی و راهنما</b>", 'ar': "📞 <b>الدعم والمساعدة</b>", 'he': "📞 <b>תמיכה ועזרה</b>", 'ru': "📞 <b>Поддержка и помощь</b>"},
    'support_unavailable': {'en': "📞 <b>Support</b>\n\n⚠️ Support is currently unavailable.", 'fa': "📞 <b>پشتیبانی</b>\n\n⚠️ در حال حاضر پشتیبانی آنلاین در دسترس نیست.", 'ar': "📞 <b>الدعم</b>\n\n⚠️ الدعم غير متاح حاليًا.", 'he': "📞 <b>תמיכה</b>\n\n⚠️ התמיכה אינה זמינה כרגע.", 'ru': "📞 <b>Поддержка</b>\n\n⚠️ Поддержка сейчас недоступна."},
    'tx_empty': {'en': "📋 No transactions yet.", 'fa': "📋 تاریخچه تراکنش خالی است.", 'ar': "📋 لا توجد معاملات بعد.", 'he': "📋 אין עסקאות עדיין.", 'ru': "📋 Транзакций пока нет."},
    'tx_title': {'en': "📋 <b>My Transactions</b>", 'fa': "📋 <b>تراکنش‌های من</b>", 'ar': "📋 <b>معاملاتي</b>", 'he': "📋 <b>העסקאות שלי</b>", 'ru': "📋 <b>Мои транзакции</b>"},
    'user_panel_btn': {'en': "👤 User Panel", 'fa': "👤 پنل کاربری", 'ar': "👤 لوحة المستخدم", 'he': "👤 פאנל משתמש", 'ru': "👤 Панель пользователя"},
    'wallet_title': {'en': "💰 <b>Wallet</b>", 'fa': "💰 <b>کیف پول</b>", 'ar': "💰 <b>المحفظة</b>", 'he': "💰 <b>ארנק</b>", 'ru': "💰 <b>Кошелёк</b>"},
}
