...
_T: dict[str, dict[str, str]] = {
    ...
    'btn_resend_hash': {'en': '🔄 Resend Hash', 'fa': '🔄 ارسال مجدد هش', 'ar': '🔄 إعادة إرسال الهاش', 'he': '🔄 שלח שוב האש', 'ru': '🔄 Отправить хэш снова'},
    ...
    'svc_unavailable': {'en': '⚠️ Service unavailable.', 'fa': '⚠️ سرویس در دسترس نیست.', 'ar': '⚠️ الخدمة غير متاحة.', 'he': '⚠️ השירות אינו זמין.', 'ru': '⚠️ Сервис недوступен.'},
    ...
    'smm_bal_low': {'en': '❌ Insufficient balance.', 'fa': '❌ موجودی کافی نیست.', 'ar': '❌ رصيد غير كافٍ.', 'he': '❌ יתרה לא מספיקה.', 'ru': '❌ Недостаточно средств.'},
...
_STATUS: dict[str, dict[str, str]] = {'pending': {'en': '⏳ Pending', 'fa': '⏳ در صف', 'ar': '⏳ قيد الانتظار', 'he': '⏳ ממתין', 'ru': '⏳ В очереди'}, 'processing': {'en': '🔄 Processing', 'fa': '🔄 در حال انجام', 'ar': '🔄 قيد المعالجة', 'he': '🔄 בעיבוד', 'ru': '🔄 В обработке'}, 'in progress': {'en': '🔄 In Progress', 'fa': '🔄 در حال انجام', 'ar': '🔄 قيد التنفيذ', 'he': '🔄 בתהליך', 'ru': '🔄 Выполняется'}, 'completed': {'en': '✅ Completed', 'fa': '✅ تکمیل شده', 'ar': '✅ مكتمل', 'he': '✅ הושלם', 'ru': '✅ Выполнен'}, 'partial': {'en': '⚠️ Partial', 'fa': '⚠️ ناقص', 'ar': '⚠️ جزئي', 'he': '⚠️ חלקי', 'ru': '⚠️ Частичный'}, 'cancelled': {'en': '❌ Cancelled', 'fa': '❌ کنسل شده', 'ar': '❌ ملغى', 'he': '❌ בוטל', 'ru': '❌ Отменён'}, 'canceled': {'en': '❌ Cancelled', 'fa': '❌ کنسل شده', 'ar': '❌ ملغى', 'he': '❌ בוטל', 'ru': '❌ Отменён'}, 'failed': {'en': '💔 Failed', 'fa': '💔 ناموفق', 'ar': '💔 فشل', 'he': '💔 נכשל', 'ru': '💔 Ошибка'}, 'refunded': {'en': '↩️ Refunded', 'fa': '↩️ برگشت خورده', 'ar': '↩️ مسترد', 'he': '↩️ הוחזר', 'ru': '↩️ Возвращён'}, 'rejected': {'en': '❌ Rejected', 'fa': '❌ رد شده', 'ar': '❌ مرفوض', 'he': '❌ נדחה', 'ru': '❌ Отклонён'}, 'approved': {'en': '✅ Approved', 'fa': '✅ تایید شده', 'ar': '✅ موافق عليه', 'he': '✅ אושר', 'ru': '✅ Одобрен'}}
