...
async def adm_backup(cb: CallbackQuery):
    ...
    await cb.message.edit_text(
        f"\U0001f5c4 <b>\u0633\u06cc\u0633\u062a\u0645 \u0628\u06a9\u0627\u067e</b>\n\n"
        f"\U0001f4cc \u06af\u0631\u0648\u0647 \u062f\u0631\u06cc\u0627\u0641\u062a: <code>{group_id}</code>\n"
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="\U0001f4cc \u062a\u0646\u0638\u06cc\u0645 \u06af\u0631\u0648\u0647",  callback_data="adm_backup_set_group"),
...
async def adm_backup_set_group(cb: CallbackQuery, state: FSMContext):
    ...
    await cb.message.edit_text(
        "\U0001f4cc <b>\u062a\u0646\u0638\u06cc\u0645 \u06af\u0631\u0648\u0647 \u062f\u0631\u06cc\u0627\u0641\u062a \u0628\u06a9\u0627\u067e</b>\n\n"
...
async def adm_backup_group_input(msg: Message, state: FSMContext, bot: Bot):
    ...
    try:
        await bot.send_message(gid_int,
            "\u2705 <b>\u06af\u0631\u0648\u0647 \u0628\u06a9\u0627\u067e \u062a\u0646\u0638\u06cc\u0645 \u0634\u062f!</b>\n\u0627\u0632 \u0627\u06cc\u0646 \u067e\u0633 \u0628\u06a9\u0627\u067e\u200c\u0647\u0627 \u0627\u06cc\u0646\u062c\u0627 \u0627\u0631\u0633\u0627\u0644 \u0645\u06cc\u200c\u0634\u0648\u0646\u062f.",
            parse_mode="HTML")
        await state.clear()
        async with AsyncSessionLocal() as session:
        ...
        await msg.answer(f"\u2705 \u06af\u0631\u0648\u0647 <code>{gid_int}</code> \u062a\u0646\u0638\u06cc\u0645 \u0634\u062f.",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="\U0001f5c4 \u0628\u0627\u0632\u06af\u0634\u062a \u0628\u0647 \u0628\u06a9\u0627\u067e", callback_data="adm_backup")]
            ]), parse_mode="HTML")
    except Exception as e:
        await msg.answer(f"\u274c \u062e\u0637\u0627 \u062f\u0631 \u0627\u0631\u0633\u0627\u0644 \u0628\u0647 \u06af\u0631\u0648\u0647:\n<code>{e}</code>\n\n\u0645\u0637\u0645\u0626\u0646 \u0634\u0648\u06cc\u062f \u0628\u0627\u062a \u0639\u0636\u0648 \u0648 \u0627\u062f\u0645\u06cc\u0646 \u06af\u0631\u0648\u0647 \u0627\u0633\u062a.", parse_mode="HTML")
...
async def adm_backup_set_interval(cb: CallbackQuery, state: FSMContext):
    ...
    await cb.message.edit_text(
        "\u23f1 <b>\u0641\u0627\u0635\u0644\u0647 \u0632\u0645\u0627\u0646\u06cc \u0628\u06a9\u0627\u067e \u062e\u0648\u062f\u06a9\u0627\u0631</b>\n\n\u062a\u0639\u062f\u0627\u062f \u0633\u0627\u0639\u062a \u0631\u0627 \u0648\u0627\u0631\u062f \u06a9\u0646\u06cc\u062f \u06cc\u0627 \u06cc\u06a9\u06cc \u0631\u0627 \u0627\u0646\u062a\u062e\u0627\u0628 \u06a9\u0646\u06cc\u062f:",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
...
async def adm_backup_restore_file(msg: Message, state: FSMContext, bot: Bot):
    ...
    try:
        ...
        zip_bytes = buf.read()
        await status_msg.edit_text("\u23f3 <b>\u0628\u0627\u0632\u06af\u0631\u062f\u0627\u0646\u06cc \u062f\u06cc\u062a\u0627\u0628\u06cc\u0633...</b>", parse_mode="HTML")
        result = await restore_from_zip(zip_bytes)
        lines = ["\u267b\ufe0f <b>\u0646\u062a\u06cc\u062c\u0647 \u0628\u0627\u0632\u06af\u0631\u062f\u0627\u0646\u06cc:</b>\n"]
        for k,v in result.items():
            if k=="metadata":
                if isinstance(v,dict): lines.append(f"\U0001f4cb \u0628\u06a9\u0627\u067e \u0627\u0632: <code>{v.get('timestamp','?')}</code>")
                continue
            lines.append(f"  \u2022 {k}: {v}")
